...
- **Personally-marked places survive every replan.** A place tagged 🐞 (Jadzia), 🦐 (Olaf) or 🦑 (Szymon) is that person's own request — when trimming or re-planning a day, cut from the unmarked stops first. Reschedule a marked place, never delete it; if it truly can't fit, flag it out loud instead of dropping it quietly. See the personal-marker convention above.

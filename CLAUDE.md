...
- **Museums are high priority — 4–7 a day is normal.** This family routinely visits four to seven museums/galleries in a single day and would rather add one than cut one. Never drop or downgrade a museum for "too many museums" / "no time for a third museum" reasons — schedule every worthwhile one (a third or fourth in an afternoon is fine), flag tight closing/last-entry times so they move briskly, and let them pace on the day.
